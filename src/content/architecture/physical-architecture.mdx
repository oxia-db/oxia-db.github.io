...
> We might consider supporting store status and metadata in the data node for bootstrapping purposes. More [discussion](https://github.com/orgs/oxia-db/discussions) is needed here.
