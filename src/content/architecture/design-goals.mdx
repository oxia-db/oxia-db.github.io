...
Oxia has been designed to be a system suitable for storing metadata and coordinating a large cluster of nodes.
...
Oxia is designed to efficiently store metadata larger than the available RAM, in the order of 100s of GB,
...
Oxia is designed to work natively in a Kubernetes environment. There is an [Oxia Helm Chart](../deployment/kubernetes/helm.mdx) provided
